...
| **VIF**                 | `compute_vif`, `remove_high_vif`                          | Algoritmo NumPy puro (fallback) ou Statsmodels; categóricas codificadas automaticamente (WOE quando possível); compatível com `polars` e `dask`                                                   |
...
vs = Vassoura(
    ...
    params={
        ...
        "boruta_models": ["lgbm"],
        "boruta_n_iter": 25,
        "boruta_sample_frac": 0.5,
        "boruta_shap_rows": 1000,
